...
import csv
import pathlib
from simulator.grouping.insert_db import InsertDB
...
def main():
    ...
    if args.custom_dataset is not None:
        loaded_dataset = load_dataset_from_text_file(args.custom_dataset)
        workload.set_custom_dataset(loaded_dataset)
